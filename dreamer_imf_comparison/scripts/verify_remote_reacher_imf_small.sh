...
BASELINE=/work2/ci72buri-dreamer_imf_neurips/policy_alignment_diagnostics/a8bd3016cc47ad2ad8eb4966c459631b5aa1b34a/report.json
ssh login01 env \
  ...
  verify --pilot-root "${PILOT}" --output "${REMOTE_OUTPUT}" \
  --baseline-diagnostics "${BASELINE}"
echo REMOTE_REACHER_IMF_SMALL_VERIFIED
